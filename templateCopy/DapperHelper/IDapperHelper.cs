...
namespace Dapper
{
    public interface IDapperHelper
    {
        ...
        /// <summary>
        /// Generate a INSERT SQL with the specify model data
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="requestData"></param>
        /// <param name="tableName"></param>
        /// <returns></returns>
        string GenerateInsertSql<T>(T requestData, string tableName, string parameterPrefix = "@");

        /// <summary>
        /// Generate a UPDATE SQL with the specify model data
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="requestData"></param>
        /// <param name="tableName"></param>
        ...
        /// <returns></returns>
        string GenerateUpdateSql<T>(T requestData, string tableName, string primaryKey, bool hasWhereSql = true, string parameterPrefix = "@");
        /// <summary>
        /// Generate a UPDATE SQL with the specify colume name list
        /// </summary>
